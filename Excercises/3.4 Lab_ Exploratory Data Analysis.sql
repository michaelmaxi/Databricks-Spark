...
SELECT 
  salesQuants.totalQuantity, 
  countryCodes.alpha3Code
FROM 
  salesQuants INNER JOIN countryCodes ON salesQuants.countryName = countryCodes.EnglishShortName
...
-- MAGIC     var allHints = document.getElementsByClassName("hint-4769");
-- MAGIC     var answer = document.getElementById("answer-4769");
...
-- MAGIC     }
-- MAGIC 
-- MAGIC     var button = document.getElementById("hint-button-4769");
...
-- MAGIC           id="hint-button-4769">Click here for a hint</button>
-- MAGIC </div>
-- MAGIC <div class="hint-4769" style="padding-bottom: 20px; display: none">
-- MAGIC   Hint:
...
-- MAGIC 
-- MAGIC 
-- MAGIC <div id="answer-4769" style="padding-bottom: 20px; display: none">
-- MAGIC   The answer:
